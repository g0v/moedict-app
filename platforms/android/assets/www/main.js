...
(function(){
  ...
  window.STARRED = STARRED = (function(){
    var results$ = {};
    for (key in HASHOF) {
      results$[key] = getPref("starred-" + key) || "";
    }
    return results$;
  }());
  res$ = {};
